...
function App() {
  ...
  const { setError, type, setType, navigator } = useContext(MyContext)
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/users/login" element={user !== null ? <Navigate to="/" /> : <Login onlogin={login} show={errorClose} />} />
        ...
        <Route path="/user/:id/edit-profile" element={!user ? <Navigate to="/404" /> : <Profile_Edit onEdit={editProfile} show={errorClose} />} />
        <Route path="/boards/:id/edit-comment" element={!user ? <Navigate to="/404" /> : <Comment_edit user={user} />} />
        ...
        <Route path="/boards/random/:id" element={<Random user={user} />} />
        <Route path="/boards/:id/details" element={<Details user={user} />} />
        <Route path="/boards/:id/edit" element={<Edit_Board user={user} show={errorClose} />} />
